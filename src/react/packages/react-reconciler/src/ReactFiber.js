...
function FiberNode(
  ...
  this.tag = tag;
  this.key = key;
  this.elementType = null; // React.createElement(elementType, props, children)
  this.type = null;
  this.stateNode = null;

  // Fiber
  this.return = null; // 指向fiber节点树中的parent
  this.child = null; // 第一个子节点
  this.sibling = null; // 指向自己的兄弟节点
  this.index = 0;
  ...
  this.dependencies = null; // 这个fiber依赖的上下文
  ...
  this.expirationTime = NoWork; // 0 代表任务在将来的某个时间点应该被完成
  this.childExpirationTime = NoWork; // 0 快速确定子树中是否有不再等待的变化
